...
SolFinale=SolFinale';
      ...
      xlabel('Index'); 
      ylabel('System Load');
      title(['Beta=' num2str(beta) '; RSQUARE=' num2str(rSquare)]);
...
%  SolReuseVect=SolReuseVect';
 rSquare= RSquare(SolutionExpected, SolReuseVect)
      ...
      xlabel('Index'); 
      ylabel('System Load');
      title(['REUSE: RSQUARE=' num2str(rSquare)]);
...
%  accuracySVMRegressionMae = abs(100 - maeSVMRegression)
      ...
      xlabel('Index'); 
      ylabel('System Load');
      title(['REVISE: RSQUARE=' num2str(rSquare)]);
...
rSquare= RSquare(SolutionExpected, PredictedReuse)
      ...
      xlabel('Index'); 
      ylabel('System Load');
      title(['REUSE COPY: RSQUARE=' num2str(rSquare)]);
      legend('Solution Reuse Copy','Solution expected');
      %error4= errorElements(SolutionExpected,Results3,nbreTest);
      ...
      xlabel('Index'); 
      ylabel('System Load');
      title(['Pso Solution : RSQUARE=' num2str(rSquare)]);
      legend('PsoSolutionVect','Solution expected');
      %error4= errorElements(SolutionExpected,Results3,nbreTest);
